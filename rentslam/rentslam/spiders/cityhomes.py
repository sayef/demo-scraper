...
class CityhomesSpider(scrapy.Spider):
    name = 'cityhomes'
    allowed_domains = ['cityhomes.nl']
    start_urls = ['http://www.cityhomes.nl/index.php/tools/blocks/houses_list/ajax_houses_list?blockID=490&city=Amsterdam&rentPrice=0&rentPriceSliderVal=350&nrBedrooms=0&rentInterior=&rentKind=&_=1526913415674']
    ...
    def parse_house(self, response):
        ...
        contact_info = "http://www.cityhomes.nl"
