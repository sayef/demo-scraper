...
class DomicaSpider(scrapy.Spider):
    name = 'domica'
    allowed_domains = ['domica.nl']
    start_urls = ['https://domica.nl/huren/plaatsnaam-Amsterdam/', 'https://domica.nl/huren/plaatsnaam-Amstelveen']
    ...
    def parse(self, response):
        ...
        items = response.xpath("//h2[contains(@class, 'title')]//a[contains(@title, 'Te huur:')]/@href").extract()
        for item in items:
    ...
    def parse_house(self, response):
        ...
        contact_info = "http://www.domica.nl"
