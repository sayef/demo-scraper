...
class RelocationadvisersSpider(scrapy.Spider):
    name = 'relocationadvisers'
    allowed_domains = ['relocationadvisers.nl']
    start_urls = ['http://https://www.relocationadvisers.nl/aanbod/?ppage=1/']
    ...
    def parse_house(self, response):
        ...
        contact_info = "http://www.relocationadvisers.nl"
